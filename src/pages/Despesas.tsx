    ...
    <div className="flex items-center gap-2">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="pl-8 pr-3 py-1.5 bg-white border border-[hsl(35_18%_90%)] rounded-[10px] w-40 focus:outline-none text-xs font-bold"
        />
      </div>
      <button
        onClick={() => setIsBudgetModalOpen(true)}
        className="p-1.5 bg-white border border-[hsl(35_18%_90%)] text-slate-600 rounded-[10px] transition-all hover:bg-slate-50"
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="bg-white rounded-[14px] border border-[hsl(35_18%_90%)] shadow-[0_1px_4px_rgba(0,0,0,0.06)] overflow-hidden">
        <div className="px-5 py-3.5 border-b border-[hsl(35_18%_92%)]">
          <h2 className="text-[13px] font-bold text-[hsl(20_15%_8%)]">Evolução de Despesas</h2>
        </div>
        <div className="p-4">
      ...
      <div className="bg-white rounded-[14px] border border-[hsl(35_18%_90%)] shadow-[0_1px_4px_rgba(0,0,0,0.06)] overflow-hidden">
        <div className="px-5 py-3.5 border-b border-[hsl(35_18%_92%)] flex justify-between items-center">
          ...
          <span className="text-[11px] text-[hsl(30_8%_55%)]">{filteredDespesas.length} encontrados</span>
        </div>

        <div className="overflow-x-auto">
          {filteredDespesas.length === 0 ? (
            <EmptyState title="Sem despesas" description="Adicione a primeira despesa" />
          ) : (
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-[hsl(35_18%_92%)]">
                ...
                <th className="text-left text-[9px] font-bold text-[hsl(30_8%_55%)] uppercase tracking-[0.07em] px-4 py-3">Descrição</th>
                <th className="text-left text-[9px] font-bold text-[hsl(30_8%_55%)] uppercase tracking-[0.07em] px-4 py-3">Pagamento</th>
                <th className="text-left text-[9px] font-bold text-[hsl(30_8%_55%)] uppercase tracking-[0.07em] px-4 py-3 text-center">Estado</th>
                <th className="text-left text-[9px] font-bold text-[hsl(30_8%_55%)] uppercase tracking-[0.07em] px-4 py-3 text-center">Anexos</th>
                <th className="text-left text-[9px] font-bold text-[hsl(30_8%_55%)] uppercase tracking-[0.07em] px-4 py-3 text-right">Projetado</th>
                <th className="text-left text-[9px] font-bold text-[hsl(30_8%_55%)] uppercase tracking-[0.07em] px-4 py-3 text-right">Real</th>
            ...
            <tbody>
              {filteredDespesas.map((despesa: Despesa) => {
                ...
                return (
                  <tr
                    key={despesa.id}
                    className="border-b border-[hsl(35_18%_96%)] hover:bg-[hsl(38_25%_98%)] transition-colors group"
                  >
                    ...
                    <td className="px-4 py-5 text-center">
                      <StatusBadge status={despesa.estado ?? 'Pago'} />
                    </td>
                    <td className="px-4 py-5 text-center">
            ...
            <tfoot>
              <tr className="bg-[hsl(38_25%_97%)] border-t-2 border-[hsl(35_18%_88%)]">
                <td colSpan={7} className="px-4 py-3 text-[11px] font-bold text-[hsl(30_8%_55%)]">Total</td>
                <td className="px-4 py-3 text-[13px] font-black text-[hsl(20_15%_8%)] text-right">{formatCurrency(totalReal)}</td>
                <td />
              </tr>
            </tfoot>
          </table>
              ...
              >
                ...
                <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-white/5 rounded-2xl border border-slate-200 dark:border-white/10">
                  ...
                  <button
                    ...
                    className={`relative w-14 h-8 rounded-full transition-colors duration-300 ${formData.estado === 'Pago' ? 'bg-green-500' : 'bg-amber-400'
                      }`}
                  >
                    <motion.div
                      layout
