...
function Rankings() {
    ...
    <div className="relative z-50 flex flex-wrap items-center gap-2">
      ...
      {isFiltered && (
        <button
          ...
          className="flex items-center gap-1 px-3 py-1 bg-rose-50 dark:bg-rose-500/10 text-rose-600 dark:text-rose-400 hover:bg-rose-500 hover:text-white rounded-lg text-[9px] font-black uppercase tracking-widest transition-all"
        >
  ...
  return (
    <div className="flex flex-col h-full">
      <PageHeader title="Relatórios" filters={filterBar} />
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-[14px] border border-[hsl(35_18%_90%)] shadow-[0_1px_4px_rgba(0,0,0,0.06)] overflow-hidden">
          <div className="px-5 py-3.5 border-b border-[hsl(35_18%_92%)] flex items-center gap-2">
            <TrendingUp className="w-4 h-4 text-purple-600 dark:text-purple-400" />
            <h2 className="text-[13px] font-bold text-[hsl(20_15%_8%)]">Melhores Clientes</h2>
          </div>
          <div className="p-4">
        ...
        <div className="bg-white rounded-[14px] border border-[hsl(35_18%_90%)] shadow-[0_1px_4px_rgba(0,0,0,0.06)] overflow-hidden">
          <div className="px-5 py-3.5 border-b border-[hsl(35_18%_92%)] flex items-center gap-2">
            ...
            <h2 className="text-[13px] font-bold text-[hsl(20_15%_8%)]">Melhores Produtos</h2>
          </div>
          <div className="p-4">
