...
export default function Emprestimos() {
  ...
  const emprestimosFilters = (
    <div className="flex items-center gap-2">
      <div className="flex bg-white border border-[hsl(35_18%_90%)] p-0.5 rounded-[10px]">
        {['Todos', 'Pendente', 'Pago'].map((status) => (
          <button
            key={status}
            onClick={() => setStatusFilter(status as any)}
            className={`px-3 py-1 rounded-[8px] text-[11px] font-bold uppercase tracking-wider transition-all ${statusFilter === status ? 'bg-[hsl(340_72%_45%)] text-white' : 'text-slate-500'}`}
          >
            {status}
          </button>
        ))}
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="bg-white rounded-[14px] border border-[hsl(35_18%_90%)] shadow-[0_1px_4px_rgba(0,0,0,0.06)] overflow-hidden">
        <div className="px-5 py-3.5 border-b border-[hsl(35_18%_92%)] flex justify-between items-center">
          <h2 className="text-[13px] font-bold text-[hsl(20_15%_8%)]">Histórico de Empréstimos</h2>
          <span className="text-[11px] text-[hsl(30_8%_55%)]">{filteredEmprestimos.length} registos</span>
        </div>

        <div className="overflow-x-auto">
          {filteredEmprestimos.length === 0 ? (
            <EmptyState title="Sem créditos" description="Adicione o primeiro registo" />
          ) : (
            <table className="w-full">
              <thead>
                <tr className="border-b border-[hsl(35_18%_92%)]">
                  <th className="text-left text-[9px] font-bold text-[hsl(30_8%_55%)] uppercase tracking-[0.07em] px-4 py-3">Data Pedido</th>
                  <th className="text-left text-[9px] font-bold text-[hsl(30_8%_55%)] uppercase tracking-[0.07em] px-4 py-3">Pessoa</th>
                  <th className="text-left text-[9px] font-bold text-[hsl(30_8%_55%)] uppercase tracking-[0.07em] px-4 py-3">Valor</th>
                  <th className="text-left text-[9px] font-bold text-[hsl(30_8%_55%)] uppercase tracking-[0.07em] px-4 py-3 text-center">Estado</th>
                  <th className="text-left text-[9px] font-bold text-[hsl(30_8%_55%)] uppercase tracking-[0.07em] px-4 py-3">Data Pagamento</th>
                  <th className="text-left text-[9px] font-bold text-[hsl(30_8%_55%)] uppercase tracking-[0.07em] px-4 py-3">Observações</th>
